...
return [
    ...
    */
    ...
    |---------------------------------------------------------------------------
    |
    | This value sets the path where Livewire's JavaScript and CSS assets are
    | served from. This is useful when your application is in a subdirectory.
    |
    */
    ...
    |---------------------------------------------------------------------------
    |
    | This value sets the root URL for Livewire update endpoint.
    |
    */
